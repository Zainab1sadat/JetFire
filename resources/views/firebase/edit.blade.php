            ...
            <form action="{{ url('update-contact/' .$key)}}" method="post">
                ...
                <div class="form-group mb-5">
                    <div class="mb-4">
                        ...
                        <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Enter Name" name="name" value="{{$test['name']}}">
                ...
                <div class="form-group mb-3">
                    <div class="mb-4">
                        ...
                        <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Enter Last Name" name="lastname" value="{{$test['lastname']}}">
                ...
                <div class="form-group mb-3">
                    <div class="mb-4">
                        ...
                        <input type="number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Enter Mobile" name="mobile" value="{{$test['mobile']}}">
